...
Last README file update: Sun Feb 06 01:38:03 GMT 2022
...
command.listwarps
command.locate
command.locate.ae2:meteorite
command.locate.bastion_remnant
command.locate.beyond_earth:alien_village
command.locate.beyond_earth:crimson_village
command.locate.beyond_earth:meteor
command.locate.beyond_earth:oil_well
command.locate.beyond_earth:venus_bullet
command.locate.beyond_earth:venus_tower
command.locate.blue_skies:everbright_blinding_dungeon
command.locate.blue_skies:everdawn_blinding_dungeon
command.locate.blue_skies:frozen_bunker
...
command.locate.minecolonies:empty_colony
...
command.locate.quark:mega_dungeon
...
command.locate.tconstruct:blood_island
...
command.locate.tconstruct:sky_slime_island
...
command.openguiscreen.identifier
command.particle
